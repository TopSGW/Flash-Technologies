export const French = {
  ...
  "Flash Transfer is the world's first platform that allows you to buy crypto with cash, transfer, or sell cryptocurrencies for cash through our network of merchants, with reasonable fees. Flash Wallet, our non-custodial wallet, has a smart contract that you can use to transfer your crypto in the event of death. When making payments on the blockchain, you can use Flash Pay, our escrow smart contract, to secure your transactions without any third party holding your crypto. Find the best fees with Flash Dex, our aggregator swap & bridge!":
    "Flash Transfer est la première plateforme au monde qui vous permet d'acheter des cryptomonnaies avec de l'argent, de transférer ou de vendre des cryptomonnaies contre de l'argent via notre réseau de marchands, moyennant des frais raisonnables. Flash Wallet, notre portefeuille non dépositaire, a un contrat intelligent que vous pouvez utiliser pour transférer votre crypto en cas de décès. Lorsque vous effectuez des paiements sur la blockchain, vous pouvez utiliser Flash Pay, notre contrat intelligent d'entiercement, pour sécuriser vos transactions sans qu'aucun tiers ne détienne votre crypto. Trouvez les meilleurs frais avec Flash Dex, notre agrégateur swap & bridge !",
  CONTACT: "CONTACT",
  "Contact Us": "Nous contacter",
  "Whether you have a question about one of our services or want to get involved in our mission, we are ready to help.":
    "Que vous ayez une question sur l'un de nos services ou que vous souhaitiez vous impliquer dans notre mission, nous sommes prêts à vous aider.",
  ...
  "Communication English & German. Works in":
    "Communication en anglais et en allemand. Travaille dans",
  ...
  "Chief marketing officer. Works as a":
    "Directeur du marketing. Travaille en tant qu'",
  "Expert in marketing and public relations":
    "expert en marketing et en relations publiques",
  "Dev. Team": "Dev. Team",
  ...
  "Your Flash increases in value according to the evolution of the course. When Flash Technologies projects evolve, it has a positive impact on the price.":
    "La valeur de votre Flash augmente en fonction de l'évolution du cours. Lorsque les projets Flash Technologies évoluent, cela a un impact positif sur le prix.",
  "On which site will the token be listed?":
    "Sur quel site le jeton sera-t-il répertorié ?",
  "The token will be listed on cex and dex.":
    "Le jeton sera listé sur le cex et le dex.",
  "Why transaction fees?": "Pourquoi des frais de transaction ?",
  "Transaction fees support the project.":
    "Les frais de transaction soutiennent le projet.",
  ...
  "Flash dex dapps is an all-in-one swap and bridge that allows users to swap their crypto assets from the same blockchain or from one blockchain to another. With the best possible direct market fees.":
    "Flash dex dapps est un swap et un pont tout-en-un qui permet aux utilisateurs d'échanger leurs crypto-actifs de la même blockchain ou d'une blockchain à une autre. Avec les meilleurs frais du marché en direct qui sont possibles.",
  ...
  "The 'dead-wallet' function. This function enables the recovery of cryptos in another wallet in case of loss of seed phrase and in the event of a death of a crypto holder. It is embedded with a smart-contract linked to a timer that automatically triggers the transfer of funds out of the wallet after a period of time has elapsed. With extra security if ever the dead wallet doesn't have enough gas costs.":
    "La fonction 'portefeuille mort'. Cette fonction permet la récupération de cryptos dans un autre portefeuille en cas de perte de phrase de départ et en cas de décès d'un détenteur de crypto. Il est intégré à un contrat intelligent lié à une minuterie qui déclenche automatiquement le transfert de fonds hors du portefeuille après un certain temps. Avec une sécurité supplémentaire si jamais le portefeuille mort n'a pas assez de frais d'essence.",
  "Flash Pay": "Flash Pay",
  "FlashPay, escrow agreements can be created quickly by buyer or seller. Once receipt of goods or services is confirmed funds are immediately transferred to the seller via the smart contract. In the event of a dispute, Flash Pay settles the dispute with the evidence received. At no time are the funds held by Flash Pay, everything is decentralized via the smart contract. Flash Pay can only validate or refuse the payment, nothing else.":
    "FlashPay, les accords d'entiercement peuvent être créés rapidement par l'acheteur ou le vendeur. Une fois la réception des biens ou des services confirmée, les fonds sont immédiatement transférés au vendeur via le contrat intelligent. En cas de litige, Flash Pay règle le litige avec les preuves reçues. A aucun moment les fonds ne sont détenus par Flash Pay, tout est décentralisé via le smart contract. Flash Pay ne peut que valider ou refuser le paiement, rien d'autre.",
  "Customers and merchants have the opportunity to earn rewards by using the staking protocol. Each month stakers receive a % of our staking pool.":
    "Les clients et les marchands ont la possibilité de gagner des récompenses en utilisant le protocole de jalonnement. Chaque mois, les jalonneurs reçoivent un % de notre pool de jalonnement.",
  ...
  "Flash pad is our launchpad for upcoming IDOs and allows crypto projects to create their tokens (BNB Chain, Polygon, Eth & Cronos) and raise funds in pre-sales or fair launches.":
    "Flash pad est notre rampe de lancement pour les OID à venir et permet aux projets cryptographiques de créer leurs jetons (BNB Chain, Polygon, Eth & Cronos) et de lever des fonds lors de préventes ou de lancements équitables.",
  ...
  "The Flash recharge is a prepaid card that allows users to top up their account in $ BUSD on the Flash wallet without any intermediary.":
    "La recharge Flash est une carte prépayée qui permet aux utilisateurs de recharger leur compte en $ BUSD sur le Flash wallet sans aucun intermédiaire.",
  "Flash Recharge allows users to top up their balance on Flash Wallet.":
    "Flash Recharge permet aux utilisateurs de recharger leur solde sur Flash Wallet.",
  "The Flash recharge's cards will be printed at the time of purchase for an eco-responsible approach.":
    "Les cartes de recharge Flash seront imprimées au moment de l'achat pour une démarche éco-responsable.",
  "Cash to crypto and vice versa.":
    "De l'argent liquide aux crypto-monnaies et vice-versa.",
  ...
  "Clients can stake Flash or our approved partner's tokens for a certain period of time in order to earn rewards and bonuses":
    "Les clients peuvent miser les jetons de Flash ou de nos partenaires approuvés pendant une certaine période afin de gagner des récompenses et des bonus.",
  Stake: "Stake",
  "Stake FLASH and receive rewards.":
    "Misez sur FLASH et recevez des récompenses.",
  ...
  "Users can choose the staking terms and hold their stake for s period of time to earn higher yield bonus returns.":
    "Les utilisateurs peuvent choisir les conditions de mise et conserver leur mise pendant une certaine période pour gagner des bonus de rendement plus élevés.",
  "Pay via Flash and partner tokens":
    "Payer via Flash et les jetons des partenaires",
  "After every successful stake, users are rewarded with Flash token as a farming bonus and partners tokens.":
    "Après chaque mise réussie, les utilisateurs sont récompensés par un jeton Flash comme bonus d'exploitation et des jetons partenaires.",
  ...
  "Holders of the AIRDROP NFTS receive Flash tokens every month. The amount differs depending on the rarity of the NFT. It also gives access to other benefits including the vip club (call nft & tokens), whitelist, discounts and other benefits that will be disclosed in the future.":
    "Les détenteurs du NFTS AIRDROP reçoivent des jetons Flash tous les mois. Le montant varie en fonction de la rareté du NFT. Il donne également accès à d'autres avantages, notamment le vip club (call nft & tokens), la whitelist, des réductions et d'autres avantages qui seront divulgués à l'avenir.",
  ...
  "Will entitle you to fees on money transfer site transactions.":
    "Vous donnera droit à des frais sur les transactions du site de transfert d'argent.",
  "The NFTS DISCOUNT ON TRANSACTION FEES provide discounts on transaction fees. The reduction is bigger depending on the rarity of the NFT. It also gives access to other benefits including the vip club (call nft & tokens), whitelist, discounts and other benefits that will be disclosed later.":
    "Les NFTS DISCOUNT ON TRANSACTION FEES offrent des réductions sur les frais de transaction. La réduction est plus importante en fonction de la rareté du NFT. Elle donne également accès à d'autres avantages, notamment le vip club (call nft & tokens), la whitelist, des réductions et d'autres avantages qui seront divulgués ultérieurement.",
  "Random effect": "Effet aléatoire",
  "Every 3 months or 6 months the function of the NFT changes.":
    "Tous les 3 ou 6 mois, la fonction du NFT change.",
  "The NFTS RANDOM EFFECT change abilities every 4 months. The benefit is greater depending on the rarity of the NFT. It also gives access to other benefits including the vip club (call nft & tokens), whitelist, discounts and other benefits that will be disclosed later.":
    "Les NFTS RANDOM EFFECT changent de capacité tous les 4 mois. Le bénéfice est plus important en fonction de la rareté du NFT. Il donne également accès à d'autres avantages dont le vip club (call nft & tokens), la whitelist, des réductions et d'autres avantages qui seront divulgués ultérieurement.",
  ...
  "Unveiling of the first Flash Transfer partners":
    "Dévoilement des premiers partenaires de Flash Transfert",
  ...
  "Launch Flash Transfer extension & application Android + IOS":
    "Lancer l'extension et l'application Flash Transfer Android + IOS",
  2023: "2023",
  "Flash 3.0": "Flash 3.0",
  ...
  "Launch of Flash Payment": "Lancement du Paiement Flash",
  ...
  "Waiting for VASP registration in UAE":
    "En attente d'enregistrement VASP aux EAU",
};
