export const Potugues = {
  ...
  "Flash Transfer is the world's first platform that allows you to buy crypto with cash, transfer, or sell cryptocurrencies for cash through our network of merchants, with reasonable fees. Flash Wallet, our non-custodial wallet, has a smart contract that you can use to transfer your crypto in the event of death. When making payments on the blockchain, you can use Flash Pay, our escrow smart contract, to secure your transactions without any third party holding your crypto. Find the best fees with Flash Dex, our aggregator swap & bridge!":
    "Flash Transfer é a primeira plataforma do mundo que permite que você compre criptomoedas com dinheiro, transfira ou venda criptomoedas por dinheiro por meio de nossa rede de comerciantes, com taxas razoáveis. A Flash Wallet, nossa carteira sem custódia, possui um contrato inteligente que você pode usar para transferir suas criptomoedas em caso de morte. Ao fazer pagamentos no blockchain, você pode usar o Flash Pay, nosso contrato inteligente de caução, para proteger suas transações sem que terceiros mantenham sua criptomoeda. Encontre as melhores taxas com o Flash Dex, nosso agregador swap & bridge !",
  CONTACT: "Contacto",
  ...
  "The 'dead-wallet' function. This function enables the recovery of cryptos in another wallet in case of loss of seed phrase and in the event of a death of a crypto holder. It is embedded with a smart-contract linked to a timer that automatically triggers the transfer of funds out of the wallet after a period of time has elapsed. With extra security if ever the dead wallet doesn't have enough gas costs.":
    "A função 'carteira morta'. Esta função permite a recuperação de criptos em outra carteira em caso de perda da frase inicial e em caso de falecimento de um detentor de cripto. Ele é incorporado a um contrato inteligente vinculado a um cronômetro que aciona automaticamente a transferência de fundos para fora da carteira após um período de tempo. Com segurança extra, se alguma vez a carteira morta não tiver custos de gás suficientes.",
  "Flash Pay": "Flash Pay",
